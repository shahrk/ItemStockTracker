...
`pyinstaller  --name "ItemStockTracker"  --distpath ./build/dist --workpath ./build/build --clean -w -p ".\code" --add-data ".\data\plus.png;.\data\"  --add-data ".\data\tracker.txt;.\data\" --hidden-import "plyer.platforms.win.notification" --noconfirm ./code/GUI.py`

For Mac

`pyinstaller  --name "ItemStockTracker"  --distpath ./build/distMac --workpath ./build/buildMac --clean -w -p "./code" --add-data "./data/plus.png:./data/"  --add-data "./data/tracker.txt:./data/"  --noconfirm ./code/GUI.py`
